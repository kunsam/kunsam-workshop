  ...
  useEffect(() => {
    ...
    function init() {
      ...
      const material = new THREE.ShaderMaterial({
        uniforms: {
          color: { value: new THREE.Color(0x7818eb) },
        },
    ...
    function render() {
      ...
      camera.position.x = 100 - scrollY * 0.1;
      camera.position.y = 300 - scrollY * 2;
      camera.position.z = 3000 - scrollY * 10;
      // camera.lookAt(scene.position);
      // console.log(scrollY, camera.position.x, "camera.position.y");
      ...
      >
        ...
        >
          <svg className={styles.svgText}>
            <text x="50" y="150" dy=".35em" textAnchor="left">
              Sam Design
            </text>
          </svg>
        </div>
